...
# Connect to device
with ProGloveClient("tcp://192.168.1.82:5566") as client:
    # Verify connection
    client.send_ping()
...
- `status_endpoint`: ZeroMQ endpoint for status (e.g., "tcp://192.168.1.82:5566" or "ipc:///tmp/proglove-left-status.ipc")
...
# Create client
client = ProGloveClient("tcp://192.168.1.82:5566")
