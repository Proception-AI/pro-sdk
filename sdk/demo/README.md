...
├── README.md             # This file
├── UPDATED_FOR_CDYLIB.md # Migration guide (uniffi → cdylib)
...
│   ├── src/proglove_demo/    # ProGlove demos
...
# Run Kapandji test (requires PyYAML: pip install pyyaml)
just kapandji
...
The C++ demos provide a complete example of using the dylib FFI from C++:
